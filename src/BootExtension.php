...
namespace Tungnt\Admin\ApiTester;
...
trait BootExtension
{
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('api-tester', 'Tungnt\Admin\ApiTester\ApiTesterController@index')->name('api-tester-index');
            $router->post('api-tester/handle', 'Tungnt\Admin\ApiTester\ApiTesterController@handle')->name('api-tester-handle');
        });
    }
